    ...
    <footer className="bg-red-900 text-yellow-200 py-12 mt-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* درباره */}
          <div>
            <h3 className="text-xl font-black mb-4 flex items-center gap-2">🏛️ IranTour Guide</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/events"
                  className="text-yellow-100 hover:text-yellow-50 transition font-bold"
                >
                  رویدادها
                </Link>
              </li>
